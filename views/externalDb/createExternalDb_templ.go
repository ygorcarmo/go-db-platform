...
func ExternalDbPage() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<h1 class=\"text-2xl\">Add New Database</h1><form class=\"border rounded border-gray-500 p-5 w-fit flex flex-col gap-2\" hx-post=\"/settings/dbs/create\" hx-target=\"#response\"><div class=\"grid grid-cols-2 gap-y-2\"><label for=\"username\" class=\"col-start-1\">Username: </label> <input type=\"text\" name=\"username\" id=\"username\" class=\"border border-slate-400 rounded p-2\" required> <label for=\"password\" class=\"col-start-1\">Password: </label><div class=\"relative col-start-2 flex\"><input type=\"password\" name=\"password\" id=\"password\" class=\"border border-slate-400 rounded p-2 flex-grow\" required> <button type=\"button\" class=\"ml-2 text-sm text-gray-600 hover:text-gray-900\" onclick=\"togglePassword()\">Show</button></div><label for=\"name\" class=\"col-start-1\">Database Name: </label> <input type=\"text\" name=\"name\" id=\"name\" class=\"border border-slate-400 rounded p-2\" required> <label for=\"host\" class=\"col-start-1\">Host: </label> <input type=\"text\" name=\"host\" id=\"host\" class=\"border border-slate-400 rounded p-2\" required> <label for=\"port\" class=\"col-start-1\">Port: </label> <input type=\"number\" name=\"port\" id=\"port\" class=\"border border-slate-400 rounded p-2\" required> <label for=\"protocol\" class=\"oracle-dg hidden\">Protocol: </label> <select name=\"protocol\" class=\"oracle-dg border border-slate-400 rounded p-2 hidden\"><option value=\"tcp\">tcp</option> <option value=\"tcps\">tcps</option></select> <label for=\"owner\" class=\"col-start-1\">Owner: </label> <input type=\"text\" name=\"owner\" id=\"owner\" class=\"border border-slate-400 rounded p-2\" required> <label for=\"type\">Type: </label> <select name=\"type\" id=\"type\" class=\"border border-slate-400 rounded p-2\"><option value=\"postgres\">postgres</option> <option value=\"mysql\">mysql/maria</option> <option value=\"oracle\">Oracle</option> <option value=\"oracle-dg\">Oracle DG</option></select> <label for=\"host-fallback\" class=\"col-start-1 oracle-dg hidden\">Host Fallback: </label> <input type=\"text\" name=\"host-fallback\" id=\"host-fallback\" class=\"border border-slate-400 rounded p-2 oracle-dg hidden\" value=\"localhost\" required> <label for=\"port-fallback\" class=\"col-start-1 oracle-dg hidden\">Port Fallback: </label> <input type=\"number\" name=\"port-fallback\" id=\"port-fallback\" class=\"border border-slate-400 rounded p-2 oracle-dg hidden\" value=\"1521\" required> <label for=\"protocol-fallback\" class=\"oracle-dg hidden\">Protocol Fallback: </label> <select name=\"protocol-fallback\" class=\"oracle-dg hidden p-2 border border-slate-400 rounded\"><option value=\"tcp\">tcp</option> <option value=\"tcps\">tcps</option></select> <label for=\"sslMode\">SSL Mode: </label> <select name=\"sslMode\" id=\"sslMode\" class=\"border border-slate-400 rounded p-2\"><option value=\"disable\">disable</option> <option value=\"require\">require</option> <option value=\"verify-ca\">verify-ca</option> <option value=\"verify-full\">verify-full</option></select></div><button type=\"submit\" class=\"bg-blue-400 py-2 px-4 rounded\">Submit</button></form><div id=\"response\"></div><script>\r\n\t\t\tfunction togglePassword() {\r\n\t\t\t\tvar passwordInput = document.getElementById('password');\r\n\t\t\t\tvar showButton = event.target;\r\n\t\t\t\tif (passwordInput.type === 'password') {\r\n\t\t\t\t\tpasswordInput.type = 'text';\r\n\t\t\t\t\tshowButton.textContent = 'Hide';\r\n\t\t\t\t} else {\r\n\t\t\t\t\tpasswordInput.type = 'password';\r\n\t\t\t\t\tshowButton.textContent = 'Show';\r\n\t\t\t\t}\r\n\t\t\t}\r\n\t\t\tdocument.getElementById('type').addEventListener('change', function () {\r\n\t\t\t\tconst selectedType = this.value;\r\n\t\t\t\tconst oracleFields = document.querySelectorAll('.oracle-dg');\r\n\t\t\t\tif (selectedType === 'oracle-dg') {\r\n\t\t\t\t\toracleFields.forEach(function (field) {\r\n\t\t\t\t\t\tfield.classList.remove('hidden');\r\n\t\t\t\t\t});\r\n\t\t\t\t} else {\r\n\t\t\t\t\toracleFields.forEach(function (field) {\r\n\t\t\t\t\t\tfield.classList.add('hidden');\r\n\t\t\t\t\t});\r\n\t\t\t\t}\r\n\t\t\t});\r\n\t\t</script>")
			if templ_7745c5c3_Err != nil {
